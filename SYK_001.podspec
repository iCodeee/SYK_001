...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/iCodeee/SYK_001"
  ...
  s.source       = { :git => "https://github.com/iCodeee/SYK_001.git", :tag => s.version.to_s }
  ...
  s.source_files  = "SYK_001/SYK_001/**/*.{h,m,swift}"
